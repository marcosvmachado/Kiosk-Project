export const divInputStyle = "w-full mx-[4px] h-[35%] border-1 border-black"
...
export const divTableTitleStyle = "w-full mx-[4px] bg-[#ffb200] text-center font-bold rounded"
export const divTableBodyStyle = "font-bold bg-[#494949] w-full mx-[4px] truncate text-center rounded"
